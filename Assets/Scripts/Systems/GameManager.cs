...
#region Singleton
    ...
    {
        players.Clear();
        PlayerMovementController[] playerMovementList = FindObjectsByType<PlayerMovementController>(FindObjectsSortMode.None);
        foreach(PlayerMovementController player in playerMovementList)
        {
